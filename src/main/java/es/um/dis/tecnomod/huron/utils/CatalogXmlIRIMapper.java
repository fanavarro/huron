...
public class CatalogXmlIRIMapper implements OWLOntologyIRIMapper {
	...
	private static final long serialVersionUID = -7941138340753822972L;

	private static final Logger logger = Logger.getLogger(CatalogXmlIRIMapper.class.getName());
						...
						if (mappedString != null) {
							if (parentFolder != null && mappedString.indexOf(":") < 0) {
								...
								try {
									...
									logger.log(Level.WARNING, "Skipping mapping: "+nameString+"   "+mappedString, e);
								}
							}
							else {
